      ...
      <div className="space-y-3">
        ...
        <div className="rounded-xl border bg-card p-4 space-y-3">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed pl-1">
            기존의 1회성 공유 URL과 달리, <strong className="text-foreground">연동된 여러 기기 간에 데이터가 실시간으로 자동 양방향 동기화</strong>됩니다. 금고 암호 기반의 종단간 암호화(E2EE) 기술을 사용하여 서버 관리자를 포함한 그 누구도 자산을 열람할 수 없어 안전합니다.
          </p>
          {/* 접근 가이드 */}
        ...
        {!isStandalone && (
          <div className="rounded-xl border bg-card p-4 space-y-3">
            ...
            <div className="rounded-lg bg-muted/40 p-2.5 text-[11px] text-muted-foreground space-y-1 border">
              ...
              <p className="leading-relaxed">
                • <strong className="text-foreground">복원</strong>: 앱을 최초 실행한 뒤, 첫 화면에서 기존의 <strong className="text-foreground">금고 암호</strong> 또는 복사된 <strong className="text-foreground">연결 코드</strong>를 입력하면 안전하게 자산이 연동됩니다.
              </p>
            </div>
          </div>
        )}
