...
export function AppGuideContent() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 mt-2 text-sm">
      {/* 피처 1: 영지식 */}
      <div className="flex flex-col gap-2 p-4 rounded-xl border border-primary/20 bg-background/50 backdrop-blur-sm shadow-sm transition-all hover:border-primary/40">
        <div className="flex items-center gap-2">
          <ShieldCheck className="size-5 text-primary shrink-0" />
          <h4 className="font-semibold text-foreground text-[14px]">영지식(Zero-Knowledge) 로컬 격리</h4>
        </div>
      ...
      <div className="flex flex-col gap-2 p-4 rounded-xl border border-primary/20 bg-background/50 backdrop-blur-sm shadow-sm transition-all hover:border-primary/40">
        <div className="flex items-center gap-2">
          ...
          <h4 className="font-semibold text-foreground text-[14px]">이중 종단간 암호화(E2EE) 동기화</h4>
        </div>
        <p className="text-muted-foreground text-xs leading-relaxed break-keep">
      ...
      <div className="flex flex-col gap-2 p-4 rounded-xl border border-primary/20 bg-background/50 backdrop-blur-sm shadow-sm transition-all hover:border-primary/40">
        <div className="flex items-center gap-2">
          ...
          <h4 className="font-semibold text-foreground text-[14px]">서버 관리자 자산 열람 원천 불가</h4>
        </div>
        <p className="text-muted-foreground text-xs leading-relaxed break-keep">
