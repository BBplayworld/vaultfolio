...
import { Download, Upload, Trash2, Sparkles, Copy, Check } from "lucide-react";
      ...
      <div className="grid grid-cols-1 gap-4 *:data-[slot=card]:shadow-xs">
        <Card>
          ...
          <CardContent className="flex flex-wrap gap-2">
            ...
            <Button onClick={() => setShowAIPromptDialog(true)} variant="outline" className="border-primary text-primary hover:bg-primary/10">
